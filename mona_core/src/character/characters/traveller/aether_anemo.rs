...
impl CharacterTrait for AetherAnemo {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        hp: [912, 2342, 3024, 4529, 5031, 5766, 6411, 7164, 7648, 8401, 8885, 9638, 10122, 10875, 10875],
        atk: [18, 46, 59, 88, 98, 113, 125, 140, 149, 164, 174, 188, 198, 212, 212],
        def: [57, 147, 190, 284, 315, 362, 402, 450, 480, 527, 558, 605, 635, 683, 683],
