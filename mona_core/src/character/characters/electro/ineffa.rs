...
impl CharacterTrait for Ineffa {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        hp: [982, 2547, 3389, 5070, 5668, 6522, 7318, 8180, 8778, 9649, 10246, 11126, 11723, 12611, 13507],
        atk: [26, 67, 90, 134, 150, 173, 194, 217, 232, 256, 271, 295, 310, 334, 358],
        def: [64, 166, 221, 330, 369, 425, 477, 533, 572, 629, 668, 725, 764, 822, 880],
