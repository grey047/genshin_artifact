...
impl CharacterTrait for KamisatoAyato {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        hp: [1068, 2770, 3685, 5514, 6165, 7092, 7960, 8897, 9548, 10494, 11144, 12101, 12751, 13715, 13715],
        atk: [23, 60, 80, 120, 134, 155, 174, 194, 208, 229, 243, 264, 278, 299, 299],
        def: [60, 155, 206, 309, 345, 397, 446, 499, 535, 588, 624, 678, 715, 769, 769],
