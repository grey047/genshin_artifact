...
impl CharacterTrait for Chiori {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        element: Element::Geo,
        hp: [890, 2310, 3073, 4598, 5141, 5915, 6638, 7420, 7962, 8751, 9293, 10091, 10634, 11438, 11438],
        atk: [25, 65, 87, 130, 145, 167, 187, 209, 225, 247, 262, 285, 300, 323, 323],
        def: [74, 192, 256, 383, 428, 493, 553, 618, 663, 729, 774, 841, 886, 953, 953],
