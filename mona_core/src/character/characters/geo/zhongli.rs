...
pub const ZHONGLI_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    element:Element::Geo,
    hp: [1144, 2967, 3948, 5908, 6605, 7599, 8528, 9533, 10230, 11243, 11940, 12965, 13662, 14695, 14695],
    atk: [20, 51, 67, 101, 113, 130, 146, 163, 175, 192, 204, 222, 233, 251, 251],
    def: [57, 149, 198, 297, 332, 382, 428, 479, 514, 564, 599, 651, 686, 738, 738],
