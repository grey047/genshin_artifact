...
impl CharacterTrait for Navia {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        element: Element::Geo,
        hp: [985, 2555, 3399, 5086, 5686, 6542, 7341, 8206, 8806, 9679, 10278, 11161, 11761, 12650, 12650],
        atk: [27, 71, 94, 141, 158, 182, 204, 228, 245, 269, 286, 310, 327, 352, 352],
        def: [62, 160, 213, 319, 356, 410, 460, 515, 552, 607, 644, 700, 737, 793, 793],
