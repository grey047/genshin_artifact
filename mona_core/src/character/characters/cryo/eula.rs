...
pub const EULA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [1030, 2671, 3554, 5317, 5944, 6839, 7675, 8579, 9207, 10119, 10746, 11699, 12296, 13226, 13226],
    atk: [27, 69, 92, 138, 154, 177, 198, 222, 238, 262, 278, 302, 318, 342, 342],
    def: [58, 152, 202, 302, 337, 388, 436, 487, 523, 574, 610, 662, 698, 751, 751],
