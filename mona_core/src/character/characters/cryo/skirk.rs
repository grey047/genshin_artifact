...
pub const SKIRK_SKILL: SkirkSkillType = SkirkSkillType {
    ...
    // Constellations
    c1_dmg: [5.00; 15],    // 水晶刃 500% (decimal)
    c2_atk: 0.70,          // +70% ATK
...
impl CharacterTrait for Skirk {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            ...
            CharacterSkillMapItem { index: SkirkDamageEnum::Normal4_1 as usize, text: hit_n_dmg!(4) },
            CharacterSkillMapItem { index: SkirkDamageEnum::Normal4_2 as usize, text: locale!(zh_cn: "四段伤害(七相第2击)", en: "4th Hit (Seven-Phase 2nd)") },
