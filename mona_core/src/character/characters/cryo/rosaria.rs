...
pub const ROSARIA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [1030, 2647, 3417, 5118, 5665, 6516, 7245, 8096, 8643, 9493, 10040, 10891, 11438, 12289, 12289],
    atk: [20, 52, 67, 100, 111, 127, 141, 158, 169, 185, 196, 213, 223, 240, 240],
    def: [60, 153, 197, 296, 327, 376, 418, 468, 499, 548, 580, 629, 661, 710, 710],
