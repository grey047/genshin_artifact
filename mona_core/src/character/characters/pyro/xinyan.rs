...
pub const XINYAN_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [939, 2413, 3114, 4665, 5163, 5939, 6604, 7379, 7878, 8653, 9151, 9927, 10425, 11201, 11201],
    atk: [21, 54, 69, 103, 115, 132, 147, 164, 175, 192, 203, 220, 231, 249, 249],
    def: [67, 172, 222, 333, 368, 423, 471, 526, 562, 617, 652, 708, 743, 799, 799],
