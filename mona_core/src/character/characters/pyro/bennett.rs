...
pub const BENNETT_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [1039, 2670, 3447, 5163, 5715, 6573, 7309, 8186, 8719, 9577, 10129, 10987, 11539, 12397, 12397],
    atk: [16, 41, 53, 80, 88, 101, 113, 126, 134, 148, 156, 169, 178, 191, 191],
    def: [65, 166, 214, 321, 356, 409, 455, 508, 542, 596, 630, 684, 718, 771, 771],
