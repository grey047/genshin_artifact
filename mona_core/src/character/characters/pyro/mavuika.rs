...
impl CharacterTrait for Mavuika {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        hp: [977, 2535, 3373, 5046, 5642, 6491, 7285, 8143, 8738, 9604, 10199, 11074, 11670, 12552, 12552],
        atk: [28, 72, 96, 144, 161, 186, 208, 233, 250, 274, 292, 317, 334, 359, 359],
        def: [62, 160, 213, 318, 356, 409, 459, 514, 551, 606, 643, 698, 736, 792, 792],
