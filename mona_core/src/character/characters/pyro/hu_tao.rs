...
pub const HU_TAO_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [1211, 3141, 3999, 6073, 6683, 7735, 8548, 9611, 10221, 11293, 11903, 12988, 13598, 14691, 15796],
    atk: [8, 21, 44, 58, 75, 82, 104, 111, 127, 134, 151, 158, 174, 182, 206],
    def: [68, 177, 229, 346, 383, 443, 492, 552, 589, 650, 687, 748, 785, 847, 909],
