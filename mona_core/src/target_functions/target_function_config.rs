...
pub enum TargetFunctionConfig {
    ...
    SkirkDefault { use_charged_attack: f64, death_stacks: usize, serpent_points: f64, void_realm_cracks: usize, extinction_active: bool, has_all_hydro_cryo_team: bool },
    SkirkBurst { death_stacks: usize, serpent_points: f64, has_all_hydro_cryo_team: bool },
    ...
    IneffaDefault { recharge_demand: f64, use_skill: f64, use_burst: f64, moonsign_level: usize },
    LaumaDefault { recharge_demand: f64, use_skill: f64, use_burst: f64, moonsign_level: usize },
    NeferDefault { recharge_demand: f64, use_skill: f64, use_burst: f64, moonsign_level: usize },
    NoConfig,
}
