...
use crate::character::characters::hydro::columbina::Columbina;
...
impl TargetFunction for ColumbinaDefaultTargetFunction {
    ...
    fn target(&self, attribute: &SimpleAttributeGraph2, character: &Character<SimpleAttributeGraph2>, _weapon: &Weapon<SimpleAttributeGraph2>, _artifacts: &[&Artifact], _enemy: &Enemy) -> f64 {
        ...
        let dmg_skill = Columbina::damage::<SimpleDamageBuilder>(&context, S::E1, &s_config, None).normal.expectation;
        let dmg_burst = Columbina::damage::<SimpleDamageBuilder>(&context, S::Q1, &s_config, None).normal.expectation;
