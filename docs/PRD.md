...
* Skill scaling structs also encode shield absorption curves. Fields like `e_shield`/`e_shield_fixed` pair a percentage applied to the driving stat (ATK, HP, or EM depending on which builder method the character invokes) with a flat bonus that feeds into `builder.shield`, producing the final absorption value after shield-strength modifiers are considered.【F:mona_core/src/character/characters/anemo/lanyan.rs†L30-L51】【F:mona_core/src/character/characters/anemo/lanyan.rs†L166-L174】 Lan Yan demonstrates an ATK-scaling example, Citlali scales via Elemental Mastery, and Kirara splits tap versus hold strengths across `e_shield1`/`e_shield2` arrays for her multi-stage skill.【F:mona_core/src/character/characters/cryo/citlali.rs†L31-L52】【F:mona_core/src/character/characters/cryo/citlali.rs†L201-L208】【F:mona_core/src/character/characters/dendro/kirara.rs†L34-L62】
